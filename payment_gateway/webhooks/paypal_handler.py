...
def handle_paypal_webhook():
    ...
    Returns:
        tuple: (dict, status_code) - Raw response data and HTTP status
    """
    try:
        ...
        return {'error': 'Invalid JSON payload'}, 200
    except Exception as e:
